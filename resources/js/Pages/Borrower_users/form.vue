  ...
  <form @submit.prevent="submit" class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        ...
        <InputError class="mt-1" :message="form.name" />
      </div>
      <div>
        <label for="last_name" class="block text-sm font-medium text-gray-700">Apellido:</label>
        <input type="text" v-model="form.last_name" id="last_name" required
          class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        <InputError class="mt-1" :message="form.last_name" />
      </div>
      <div>
        ...
        <input type="text" v-model="form.telephone_con" id="telephone_con" required
          class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        <InputError class="mt-1" :message="form.telephone_con" />
      </div>
      <div>
        ...
        <input type="text" v-model="form.address_add" id="address_add" required
          class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        <InputError class="mt-1" :message="form.address_add" />
      </div>
      <div>
        ...
        <input type="email" v-model="form.email_con" id="email_con" required
          class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        <InputError class="mt-1" :message="form.email_con" />
      </div>
      <div>
        ...
        <InputError class="mt-1" :message="form.roll" />
      </div>
      <div>
        ...
        <InputError class="mt-1" :message="form.type_identification" />
      </div>
      <div>
        ...
        <input type="text" v-model="form.number_identification" id="number_identification" required
          class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        <InputError class="mt-1" :message="form.number_identification" />
      </div>
      <div>
        ...
        <InputError class="mt-1" :message="form.sex_user" />
      </div>
      <div>
        <label for="gender_sex" class="block text-sm font-medium text-gray-700">Género:</label>
        ...
        <InputError class="mt-1" :message="form.gender_sex" />
      </div>
    </div>
